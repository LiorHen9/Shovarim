...
| `phone` (E.164) | `listInviteCodes` | מזהה ישיר, ו**מספר של צד שלישי** — הוזן על ידי בעל הרשימה על מישהו אחר, שאולי אינו משתמש במערכת כלל ולא נתן שום הסכמה. ראו "מספרים של לא-משתמשים" למטה. נוסף ב-ADR #37 |
